...
## Solución
```
C:\Users\yahir>ssh bandit32@bandit.labs.overthewire.org -p 2220
                         _                     _ _ _
                        | |__   __ _ _ __   __| (_) |_
                        | '_ \ / _` | '_ \ / _` | | __|
                        | |_) | (_| | | | | (_| | | |_
...
## Notas adicionales
- La variable $0 hace referencia al shell, por tanto podemos usarla para acceder a la terminal correcta
