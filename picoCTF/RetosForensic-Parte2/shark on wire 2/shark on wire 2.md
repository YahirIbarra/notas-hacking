...
## Solución
```
┌──(kali㉿kali)-[~/Documents/Retos/wire_shark_2]
...
┌──(kali㉿kali)-[~/Documents/Retos/wire_shark_2]
└─$ ls                                                                                                       130 ⨯
capture.pcap  paquetes_puerto22.txt
                                                                                                                   
┌──(kali㉿kali)-[~/Documents/Retos/wire_shark_2]
└─$ cat paquetes_puerto22.txt 
...
┌──(kali㉿kali)-[~/Documents/Retos/wire_shark_2]
└─$ cat paquetes_puerto22.txt | grep UDP
   1104 991.587437     10.0.0.66             10.0.0.1              UDP      60     5000 → 22 Len=5
   1106 993.672341     10.0.0.66             10.0.0.1              UDP      60     5112 → 22 Len=5
   1118 1006.227400    10.0.0.66             10.0.0.1              UDP      60     5105 → 22 Len=5
   1122 1008.323546    10.0.0.66             10.0.0.1              UDP      60     5099 → 22 Len=5
...
┌──(kali㉿kali)-[~/Documents/Retos/wire_shark_2]
└─$ cat paquetes_puerto22.txt | grep UDP  | awk '{print $7}' | cut -c2- | grep -v 000                          1 ⨯
112
105
099
111
