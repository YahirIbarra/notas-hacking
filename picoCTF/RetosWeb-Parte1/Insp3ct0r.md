...
## Solución
```
Inspeccionar codigo fuente HTML:
|   |
|---|
|<!doctype html>|
||<html>|
...
Inspeccionar el codigo fuente CSS:
div.container {
    width: 100%;
}
...
Inspeccionar el codigo fuente JavaScript:
...
## Notas adicionales
- Al dar clic derecho en la pagina web podemos obtener el codigo fuente de la misma y analizarlo para encontrar vulnerabilidades
