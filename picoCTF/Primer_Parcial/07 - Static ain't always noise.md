...
## Solución
```
elyahir-picoctf@webshell:~/carpeta1$ ls
ltdis.sh  static
elyahir-picoctf@webshell:~/carpeta1$ ./ltdis.sh static 
...
elyahir-picoctf@webshell:~/carpeta1$ cat static.ltdis.strings.txt 
   ...
   1969 .bss
   196e .comment
elyahir-picoctf@webshell:~/carpeta1$ cat static.ltdis.strings.txt | grep picoCTF
   1020 picoCTF{d15a5m_t34s3r_f5aeda17}
```
