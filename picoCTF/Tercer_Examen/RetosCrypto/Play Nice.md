...
## Solución
```
┌──(kali㉿kali)-[~/Documents/Retos/tercer-parcial/play-nice]
└─$ ls
playfair.py
...
* ENTRAMOS A UN DECODIFICADOR DE PLAYFAIR E INGRESAMOS EL ALFABETO Y EL MENSAJE ENCRIPTADO *


┌──(kali㉿kali)-[~/Documents/Retos/tercer-parcial/play-nice]
└─$ python3 -c "print('TKV5Z9ZPEHCLTKQFT47NY0HMNT5LTC'.lower())"                                                1 ⨯
